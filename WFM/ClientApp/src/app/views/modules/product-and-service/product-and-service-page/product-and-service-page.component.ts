...
export class ProductAndServicePageComponent implements OnInit {
  ...
  constructor(private productsAndServicesService:ProductsAndServicesService,private router: Router, private route: ActivatedRoute) { }
  ...
  columnFields = [
    ...
    { field: 'initialQty', header: 'QTY ON HAND.' ,type: 'string',visible: true},
  ...
  invoiceData = [
    {id:1, name: 'Bricks', initialQty: '', category: '', sku: '', type: '', price: '10',cost:'' },
  ];
