...
export const MENU: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      {
        label: 'Dashboard',
        link: '/inventory-management/dashboard',
      },
    ]
  ...
  },
  {
    ...
    icon: 'calendar',
    link: '/estimate-n-quotes'
  },
  {
    label: 'WorkOrder Management',
    icon: 'calendar',
    link: '/work-order'
  },
  {
  ...
  {
    label: 'IndividualLicenseSubtype',
    icon: 'users',
    link: '/IndividualLicenseSubtype'
  },
  {
    label: 'Web Apps',
    isTitle: true
