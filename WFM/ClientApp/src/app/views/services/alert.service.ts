...
export class AlertService {
  ...
  showToaster(message: string, type: SweetAlertIcon) {
    if (type == 'success')
      Swal.fire({ toast: true, position: 'top-end', showConfirmButton: false, timer: 3000, timerProgressBar: true, title: message, icon: 'success' });
    else if (type == 'error')
      Swal.fire({ toast: true, position: 'top-end', showConfirmButton: false, timer: 3000, timerProgressBar: true, title: message, icon: 'error' });
    else if (type == 'info')
      Swal.fire({ toast: true, position: 'top-end', showConfirmButton: false, timer: 3000, timerProgressBar: true, title: message, icon: 'info' });
  }

  showToasterWithTitle(title: string, message: string, type: SweetAlertIcon) {
    if (type == 'success')
      Swal.fire({ toast: true, position: 'top-end', showConfirmButton: false, timer: 3000, timerProgressBar: true, text: message, title: title, icon: 'success' });
    else if (type == 'error')
      Swal.fire({ toast: true, position: 'top-end', showConfirmButton: false, timer: 3000, timerProgressBar: true, text: message, title: title, icon: 'error' });
    else if (type == 'info')
      Swal.fire({ toast: true, position: 'top-end', showConfirmButton: false, timer: 3000, timerProgressBar: true, text: message, title: title, icon: 'info' });
      else if (type == 'warning')
      Swal.fire({ toast: true, position: 'top-end', showConfirmButton: false, timer: 3000, timerProgressBar: true, text: message, title: title, icon: 'warning' });
  }
