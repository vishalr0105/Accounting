...
export class Utilities {
  ...
  public static hasNumber(text: string) {
    return /\d+/.test(text);
  }

  public static hasCapitalCase(text: string) {
    return /[A-Z]/.test(text);
  }

  public static hasSmallCase(text: string) {
    return /[a-z]/.test(text);
  }
  ...
  public static hasValidLength(text: string, length: number) {
