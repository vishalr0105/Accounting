...
export const environment={
    ...
    production:true,
    apiUrl:"https://go.etaprise.ai",
    baseUrl: "https://go.etaprise.ai",
   // baseUrl: "https://localhost",
    //baseUrl: "http://localhost:5000",//'http://dashboard.atcemr.com', // Change this to the address of your backend API if different from frontend address
